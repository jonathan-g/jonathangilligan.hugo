...
and the 2022 Inflation Reduction Act (IRA). We found that incentives for
voluntary household actions to reduce greenhouse gas emissions account for only 
around 11% of spending, but those household actions are expected to produce 
around 40% of total emissions reductions.
