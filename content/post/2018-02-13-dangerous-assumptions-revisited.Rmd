...
![Assumed versus observed decarbonization rates, from Pielke _et al._, "[Dangerous Assumptions](https://pdfs.semanticscholar.org/afdc/e9bfa0fb51768394407d086cdeb5e9f77207.pdf)"](/img/post/gilligan-dangerous-assumptions/pielke_assumed_decarbonization.jpg)
...
and Stevenson & Pielke, and presents a much more optimisitic picture than those
analyses do.

Of course, the big cuts in the RCP 4.5 pathway occur in the future, so we should 
not take this as license for complacency. Moreover, the anomalous reversal of
...
However, the energy intensity of the world's economy has dropped more slowly
than either the reference scenario or any of the serious policy scenarios
(the exception, GCAM 8.5 may be seen as reflecting perverse policies that 
encourage energy consumption and the use of coal).
This is true at the global scale and also apparent in 
Figs \@ref{fig:china-carbon-plot} and \@ref{fig:china-energy-plot}
...
markets to provide 
[behaviorally effective incentives](/files/pubs/pdfs/stern_2010_design_principles.pdf) 
